...
rule all:
	...
	## comment out the line below if host_contamination rule fails.
        ...
        expand(config["output_dir"] + "/metaphlan/GTDB_relab/{sample}_profile.txt",sample=SAMPLES),
        ...
        config["output_dir"] + "/metaphlan/results/merged_abundance_table_SGB_relab.txt",
        config["output_dir"] + "/metaphlan/results/merged_abundance_table_SGB_species_relab.txt",
        ...
        config["output_dir"] + "/metaphlan/results/merged_abundance_table_GTDB_relab.txt",
        config["output_dir"] + "/metaphlan/results/merged_abundance_table_GTDB_species_relab.txt",
