...
rule all:
	...
	expand(config["output_dir"] + "/metaphlan/{sample}_bowtie2.bz2",sample=SAMPLES),
        ...
        config["output_dir"] + "/metaphlan/results/merged_abundance_table.txt",
        config["output_dir"] + "/metaphlan/results/merged_abundance_table_species.txt",
        config["output_dir"] + "/metaphlan/results/merged_abundance_table_GTDB.txt",
        config["output_dir"] + "/metaphlan/results/merged_abundance_table_species_GTDB.txt",
