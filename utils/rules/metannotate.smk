...
rule merge_output:
    ...
    shell:
         """
            ...
            humann_join_tables --input output/metannotate/renamed/ko/ --output {output.genefam_ko} --file_name genefamilies; 
            humann_join_tables --input output/metannotate/renamed/rxn/ --output {output.genefam_rxn} --file_name genefamilies; 
            humann_join_tables --input output/metannotate/renamed/eggnog/ --output {output.genefam_eggnog} --file_name genefamilies; 
            humann_join_tables --input output/metannotate/raw/ --output {output.pathcov} --file_name pathcoverage; 
            humann_join_tables --input output/metannotate/raw/  --output {output.pathabun} --file_name _pathabundance; """
